...
#+LATEX_HEADER: \titlespacing*{\section}{0pt}{0.4cm}{0.15cm}  
...
#+LATEX_HEADER: \newcommand{\headerspacing}{\vspace{-0.1cm}}
...
#+LATEX_HEADER: \AtBeginDocument{\begin{center}\headername\def\tempsubtitle{\resumesubtitle}\ifx\tempsubtitle\empty\else\\[\namesubtitlespacing]\headersubtitle\fi\\[\subtitlecontactspacing]{\small\headeremail $|$ \headerphone $|$ \headerlinkedin $|$ \headerwebsite $|$ \headergithub}\end{center}\headerspacing}
