...
- *Programming:* Python, SQL, R, Java, Bash, HTML
- *Cloud & DevOps:* Google Cloud Platform, Docker, Cloud Build, Bitbucket pipelines, CI/CD, Cloud Composer (Airflow)
- *Data & Analytics:* Collibra, BigQuery, Looker, Data Viz, Data Modeling
- *ML & AI:* Vertex AI, LLM, Custom model deployment
- *Tools & Platforms:* Jira, Linux, Enterprise Resource Planning (ERP), HumanFirst
...
** Sr Machine Learning Operations (MLOps) Engineer 
   ...
   :END:
- Led multiple analytical products, from an MLOps perspective especially focused on Call Center AI applications, like agent assistance, call summarisation, topic modelling. 
